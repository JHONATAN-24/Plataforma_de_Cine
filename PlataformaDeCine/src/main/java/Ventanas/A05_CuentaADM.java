...
public class A05_CuentaADM extends javax.swing.JFrame {
    // INSTANCIA DE LA CLASE ADMINISTRADOR:_____________________________________
    Administrador administrador = new Administrador();
    
    // VARIABLES PARA LA CLASE ADMINISTRADOR:___________________________________
    ...
    // IMPRIMIR EL CODIGO DEL ADMINISTRADOR AL ABRIR LA VENTANA:__________________
        System.out.println(codigoAdministrador);
    }
    ...
    private void initComponents() {
        ...
        lbInformacionUsuario.setText("Información de administrador");
        ...
        lbCodigoEncuestador.setText("Codigo de administrador");
    ...
    */
    ...
    public void MostrarNombre(){
        lbNombreCompleto.setText(nombreAdministrador + " " + apellidoAdministrador);
    }
    
    // METODO PARA MOSTRAR EL CODIGO DEL ENCUESTADOR:___________________________
    public void MostrarCodigo(){
        lbCodigoEncuestador.setText(codigoAdministrador);
    }
